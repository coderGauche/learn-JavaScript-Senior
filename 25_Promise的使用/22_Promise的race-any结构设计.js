 ...
 * @LastEditors: Gauche楽
 * @LastEditTime: 2023-06-15 02:46:59
 * @FilePath: /learn-JavaScript-Senior/25_Promise的使用/22_Promise的race-any结构设计.js
 */
...
// ZFPromise.race([p1, p2, p3]).then(res => {
//     console.log(res);
// }).catch(err => {
//     console.log('err', err);
// })

ZFPromise.any([p1, p2, p3]).then(res => {
    console.log(res);
}).catch(err => {
    console.log('err', err);
})
