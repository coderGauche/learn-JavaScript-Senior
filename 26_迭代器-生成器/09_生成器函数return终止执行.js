 ...
 * @LastEditors: Gauche楽
 * @LastEditTime: 2023-06-16 04:17:34
 * @FilePath: /learn-JavaScript-Senior/26_迭代器-生成器/09_生成器函数return终止执行.js
 */
function* foo(params) {
    console.log('函数开始执行');
    ...
    return n // Return the value generated by the first yield expression
...
console.log(generator.return(16));
